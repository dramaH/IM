  ...
  render() {
    return (
      <span style='position:relative'>
        <transition name='Drama-slide-top'>
          {this.visible && (
            <div class='Drama-popover' ref='popover' style={this.popoverStyle} on-click={e => e.stopPropagation()}>
              <div class='Drama-popover__content'>{this.$slots.content}</div>
              <div class='Drama-popover__arrow' />
            </div>
          )}
        </transition>
        {this.$slots.default}
...
.Drama-slide-top-leave-active, .Drama-slide-top-enter-active {
  transition: all 0.2s cubic-bezier(0.645, 0.045, 0.355, 1);
}

.Drama-slide-top-enter, .Drama-slide-top-leave-to {
